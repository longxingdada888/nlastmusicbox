...
contract nlastmusicbox is ERC721, Ownable {
    using Strings for uint256;

    uint256 private _nextTokenId;
    uint256 private constant _mintPrice = 0.01 ether;
    uint256 private constant _maxSupply = 10000;

    string private _base;
    constructor()

    ERC721("nlastmusicbox", "MBOX")
    {
        _base = "https://solmusicbox.org/api/token/";
    }
